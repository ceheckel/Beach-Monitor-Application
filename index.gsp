...
<div class="help-button" id="help-button" data-page-title="Help" style="display:none;">
    ...
    <div class="navbar">
        ...
        <a href="#btn-next">Next</a>
        <a href="#contact">Previous</a>
        <a href="#contact">Delete</a>
    </div>
    <!-- AUTHOR: Heckel -->

    <!-- Home Page Navigation -->
    <h1 style="color:rgb(61,81,181);padding:0px 0px 0px 10px;">Home Page</h1>
    ...
    <a name="Survey Creation" style="color:rgb(61,81,181);"><h1 style="padding:0px 0px 0px 10px;">Survey Creation</h1></a>
